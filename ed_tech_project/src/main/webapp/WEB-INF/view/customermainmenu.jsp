...
<!-- Top, right, bottom, left ----- margin -->
	<div class = "hero"><br>
	<p align="right"><a href="logoutcustomer" class="a1" style="text-decoration: none;"><button type="button" class="submit-btn1">Log Out</button></form><br><br></a></p><br>
	<marquee scrollamount="12"><center><h1 class="headingWelcome">WELCOME TO DEVED TECH MAIN MENU</h1></center></marquee><br><br><br><br><br>
	
	<div class = "form-box">
	<br>
	            <form id ="searchbuy" action="searchbuy">
				<button type="submit" class="submit-btn">SEARCH/BUY COURSE</button></form><br><br>
				<form id ="coursecatalog" action="coursecatalog">
				<button type="submit" class="submit-btn">COURSE Catalog</button></form><br><br>
		</div>
		<footer>

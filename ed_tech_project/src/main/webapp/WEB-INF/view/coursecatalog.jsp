...
<!-- Top, right, bottom, left ----- margin -->
	...
	<marquee scrollamount="12"><center><h1 class="headingWelcome">WELCOME TO ADMIN DEVED TECH MAIN MENU</h1></center></marquee><br><br><br>
	<marquee scrollamount="12"><center><h3 class="headingWelcome1">Your Purchased Courses:</h3></center></marquee><br><br>
    </h3></center><br><br><br>
	<div >
	<%-- ${courses} --%>
	<br>
	...
	<table border=1>
		...
		<c:forEach var="course" items="${courses}">
			...
			<tr>
				...
				<a href = "viewInformation?couId=${course.course_id}" style="color:cyan;font-weight:bold" >VIEW INFORMATION</a></td>
			</tr>
		</c:forEach>

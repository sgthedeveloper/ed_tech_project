...
<div class="dear"><br>
	...
	<div class="form-box" align="left";><h4>
		<form:form action="processUpdate" method="post" modelAttribute="courses">
		        <label for="id">Course ID<span style="color: #ff0000">* </span></b></label>
				<form:input type = "text" class = "input-field" placeholder = "Course Id" path="course_id" style="width: 100%;cursor: pointer;" readonly="true"/><br><br>
				...
				<form:input type = "number" class = "input-field" placeholder = "Course Original Price" path = "original_course_price" style="width: 100%;cursor: pointer;"/><br><br>
				<label for="id">Course Discount(Percentage)<span style="color: #ff0000">* </span></b></label>
				...
				<center><button type="submit"  style="width: 50%;height:50px;font-size: 30px;cursor: pointer;"><b>Update Course&#9995;</b></button></center>
			</form:form></h4></div>
		<p></p>
		<br><br><br><br>
		<footer>

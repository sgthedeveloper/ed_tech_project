...
<!-- Top, right, bottom, left ----- margin -->
	<div class = "hero"><br>
	<p align="right"><a href="logoutcustomer" class="a1" style="text-decoration: none;"><button type="button" class="submit-btn1">Log Out</button></form><br><br></a></p>
	<marquee scrollamount="12"><center><h1 class="headingWelcome">WELCOME TO DEVED TECH VIEW</h1></center></marquee><br><br><br><br><br>
	
	<center><h3 class="headingWelcome1">
     <form id ="login"class="input-group" action="searching" method = "post">
	<input type = "text" class = "input-field" placeholder = "Search In Courses" name = "couskill">
	...
	<table border=1>
		<thead>
			<tr>
				...
				<td style="color:white;font-weight:bold">Course Quantity Left</td>
		...
		<c:forEach var="course" items="${courses}">
			...
			<tr>
				...
				<a href = "buyCourse?couId=${course.course_id}" onclick = "if (!(confirm('Do you really want to buy this course?'))) return false" style="color:cyan;font-weight:bold">Buy Now</a></td>
			</tr>
		</c:forEach>

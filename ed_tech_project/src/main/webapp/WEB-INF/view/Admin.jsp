...
<!-- Top, right, bottom, left ----- margin -->
	<div class = "hero">
	<center><h1 class="headingWelcome">WELCOME TO ADMIN DEVED TECH PORTAL</h1></center>
		<div class = "form-box">
			 <form id ="login"class="input-group" action="AdminLoginServlet" method = "post">
				<br><input type = "text" class = "input-field" placeholder = "Username" name = "adminuname" required><br><br><br><br><br>

...
<!-- Top, right, bottom, left ----- margin -->
	<div class = "hero"><br>
	<p align="right"><a href="logoutadmin" class="a1" style="text-decoration: none;"><button type="button" class="submit-btn1">Log Out</button></form><br><br></a></p><br>
	...
	<br><br>
				...
				<button type="submit" class="submit-btn">ADD COURSE</button></form><br><br>
				<form id ="vecourse"action="vecourse">
				<button type="submit" class="submit-btn">VIEW/EDIT COURSE</button></form><br><br>
				<!--<form id ="sod"action="sod" method = "post">
				<button type="submit" class="submit-btn">SPECIAL OFFERS/ DISCOUNTS</button>-->
		</div>
		<footer>
